...
public class GlowEffect {
	...
	public static void main(String[] args) {
		...
		EventManager.registerEventHandler(EventManager.TICK_EVENT, "mcj_test:tick");
		MinecraftServer.exec("""
				tellraw @a {"text":"Glow Effect: ","color":"gold","extra":[\
				{"text":"[Enable]","color":"green","clickEvent":{"action":"run_command","value":"/function mcj_test:toggle {enabled:1b}"}},\
				{"text":" "},\
				{"text":"[Disable]","color":"red","clickEvent":{"action":"run_command","value":"/function mcj_test:toggle {enabled:0b}"}}]}""");
	}
